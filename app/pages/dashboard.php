<?php $blokk = false; $pageTitle = "Recruitment Dashboard"; $pageAction = true; $parent = "adm"; include '../base-t1.php';?>
...
<?php startblock('page-actions') ?>
  <span class="item">
    <a class="dropdown-toggle text-center" href="#_" title="Help" data-toggle="dropdown" data-persist="true">
      <i class="gel-icon-lg gel-icon-team" aria-hidden="true"></i> <span>Team and Users</span>
    </a>

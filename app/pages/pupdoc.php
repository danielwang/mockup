   ...
   <div class="d-none d-xl-flex col-xl-2 justify-content-xxl-end">
      <nav role="navigation" aria-label="Table of content" class="toc">
         ...
         <ol>
            ...
            <li><a href="#" aria-selected="false">Section heading 2</a></li>
            <li><a href="#" aria-selected="false">Section heading 3</a></li>
            <li><a href="#" aria-selected="false">Section heading 4</a></li>
            <li><a href="#" aria-selected="false">Section heading 5</a></li>
            <li><a href="#" aria-selected="false">Section heading 6</a></li>
         </ol>
      </nav>
   </div>
        ...
        <div id="profile" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane">
            ...
            <div aria-label="comment box" class="commentbox expanded">
                ...
                <div class="commentbox-input">
                    ...
                    <div class="text-right mt-2"><button type="button" class="btn btn-link btn-sm">Cancel</button><button type="button" class="btn btn-primary btn-sm">Send</button></div>
                </div>
            </div>
            </article>
        </div>
...
<button id="knob" class="border-top border-left border-right btn btn-icon"><i class="gel-icon-notes gel-icon-lg"></i> </button>

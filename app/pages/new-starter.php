  ...
  <div class="col-lg-3">
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-12">
        ...
        <p class="border-bottom pb-1">Organizational Introductions and Onboarding tasks <span class="float-right"><a href="#"><i class="gel-icon-add"></i></a></span></p>
        <p class="border-bottom pb-1">New starter signed contract?<span class="float-right"><a href="#"><i class="gel-icon-add"></i></a></span></p>
        <p class="border-bottom pb-1">On-site client visit <span class="float-right"><a href="#"><i class="gel-icon-add"></i></a></span></p>
      </div>
      <div class="col-sm-6 col-lg-12">
        <h5 class="mt-4 mb-1">My Favourite tasks</h5>
        <p class="border-bottom pb-1">Probation Check <span class="float-right"><a href="#"><i class="gel-icon-pencil" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"></i></a><a href="#"><i class="gel-icon-add"></i></a></span></p>
        <p class="border-bottom pb-1">Coffee with new starter <span class="float-right"><a href="#"><i class="gel-icon-pencil" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"></i></a><a href="#"><i class="gel-icon-add"></i></a></span></p>
      </div>
    </div>
  </div>
  <div class="col-lg-9">
        ...
        <tbody>
          <tr>
            ...
            <td data-title="Actions" class="d-flex justify-content-between align-items-center">
              <a href="#"><i class="gel-icon-pencil" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"></i></a>
              <a title ="Delete task" href="#" data-toggle="modal" data-target="#deleteTask"><i class="gel-icon-trash" data-toggle="tooltip" data-placement="bottom" data-original-title="Delete"></i></a><i class="dragable gel-icon-drag"></i></td>
          </tr>
          <tr>
            ...
            <td data-title="Actions" class="d-flex justify-content-between align-items-center"><a href="#"><i class="gel-icon-pencil" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"></i></a><a title ="Delete task" href="#" data-toggle="modal" data-target="#deleteTask"><i class="gel-icon-trash" data-toggle="tooltip" data-placement="bottom" data-original-title="Delete"></i></a><i class="dragable gel-icon-drag"></i></td>
          </tr>
          <tr>

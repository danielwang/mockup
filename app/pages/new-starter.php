  ...
  <div class="col-lg-3">
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-12">
        ...
        <p class="border-bottom pb-1 pr-5">Organizational Introductions and Onboarding tasks
          <span class="float-right mr-n-5"><a href="#" aria-label="Add"><i class="gel-icon-add" data-toggle="tooltip" data-placement="bottom" data-original-title="Add"></i></a></span>
        </p>
        <p class="border-bottom pb-1 pr-5">New starter signed contract?<span class="float-right mr-n-5"><a href="#" aria-label="Add"><i class="gel-icon-add" data-toggle="tooltip" data-placement="bottom" data-original-title="Add"></i></a></span></p>
        <p class="border-bottom pb-1 pr-5">On-site client visit <span class="float-right mr-n-5"><a href="#" aria-label="Add"><i class="gel-icon-add" data-toggle="tooltip" data-placement="bottom" data-original-title="Add"></i></a></span></p>
      </div>
      <div class="col-sm-6 col-lg-12">
        <h5 class="mt-4 mb-1">My Favourite tasks</h5>
        <p class="border-bottom pb-1 pr-5">Probation Check
        ...
        <p class="border-bottom pb-1 pr-5">Coffee with new starter
          <span class="float-right mr-n-5">
            <a href="#" aria-label="Edit"><i class="gel-icon-pencil" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"></i></a>
            <a href="#" aria-label="Add"><i class="gel-icon-add" data-toggle="tooltip" data-placement="bottom" data-original-title="Add"></i></a>
          </span>
